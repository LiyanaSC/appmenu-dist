...
"./mount":()=>{
      ...
      return __federation_import('/appmenu-dist/assets/__federation_expose_Mount-m-8wfifP.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
